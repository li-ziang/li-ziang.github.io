...
Previously, I obtained a B.E. in computer science from Tsinghua University. I was honored to have worked with Prof. [Jie Tang](https://keg.cs.tsinghua.edu.cn/jietang/) at Tsinghua University and Prof. [Maria Brbic](https://cs.stanford.edu/~mbrbic/), Prof. [Jure Leskovec](https://cs.stanford.edu/people/jure/) at Stanford. In the industry, I used to intern at Tencent Quantum Lab, working with Prof. [Chang-Yu Hsieh](https://scholar.google.com/citations?user=K-AjhSgAAAAJ&hl=id&oi=ao) and at [Helixon](https://www.helixon.com/), working with Prof. [Jian Peng](https://jianpeng.web.engr.illinois.edu/) and Prof. [Jianzhu Ma](https://majianzhu.com/).
...
To appear on *Nature Communications* \
...
\[[pdf](https://www.biorxiv.org/content/10.1101/2025.02.13.638154v2.full.pdf)\] \| \[[code](https://github.com/luo-group/SPURS)\] 

**Rewiring protein sequence and structure generative models to enhance protein stability prediction** \
<u><strong>Ziang Li</strong></u>, Yunan Luo \
*RECOMB 2025* \
RECOMB version of the Nature Communications paper. \
